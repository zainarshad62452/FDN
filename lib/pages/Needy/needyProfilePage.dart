...
class NeedyProfilePage extends StatefulWidget {
  @override
...
class _ProfilePageState extends State<NeedyProfilePage> {
                                        ...
                                        ...ListTile.divideTiles(
                                          ...
                                          tiles: [
                                            ...
                                            ListTile(
                                              ...
                                              title: Text("Email"),
                                              subtitle:
                                              Text("${needyCntr.user!.value.email}"),
                                            ),
                                            ListTile(
                                              leading: Icon(Icons.phone),
                                              title: Text("Phone"),
                                              subtitle: Text("${needyCntr.user!.value.contactNo}"),
                                            ),
                                          ],
                                        ),
                                      ],

...
class ForgotPasswordVerificationPage extends StatefulWidget {
   ForgotPasswordVerificationPage({Key? key,this.email}) : super(key: key);
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 10,),
                            Text(
                              'Enter the verification code we just sent you on your ${widget.email}.',
                              style: TextStyle(
                                // fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.black54
                                ...
                                children: [
                                  ...
                                  TextSpan(
                                    ...
                                    recognizer: TapGestureRecognizer()
                                      ..onTap = () {
                                      Authentication().forgotPassword(widget.email.toString());
                                      },
                                    style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        color: Colors.orange
